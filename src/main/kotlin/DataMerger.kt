 ...
 */
fun mergeMeasuresWithIssues(sonarProject: SonarProject) {

    val issuesFile = sonarProject.getProjectFolder() + "sonar-issues.csv"
    val measuresFile = sonarProject.getProjectFolder() + "measure-history.csv"
    val combinedFile = sonarProject.getProjectFolder() + "measure-and-issue-history.csv"
    ...
    FileWriter(combinedFile).use { fw ->
        ...
        logger.info("Measure and issue history merged and saved to $combinedFile")
    }
}
